...
class AccountsPage extends StatelessWidget {
  ...
  //       ledgerBooks: [
  //         LedgerBook(id: 1, title: "January", description: "January Expenses", balance: 1500.0,creationDate: DateTime(2005, 5, 15)),
  //         LedgerBook(id: 2, title: "February", description: "February Expenses", balance: 1200.0,creationDate: DateTime(2005, 5, 15)),
  //       ],
  //       alerts: [],
  //       funds: []),
  //   Account(
  ...
  //       headerPicture: "assets/header_image.png",
  //       ledgerBooks: [
  //         LedgerBook(id: 1, title: "Work", description: "work Expenses", balance: 1146.0,creationDate: DateTime(2005, 5, 15)),
  //         LedgerBook(id: 2, title: "Home", description: "Home Expenses", balance: 900.0,creationDate: DateTime(2005, 5, 15)),
  //         LedgerBook(id: 1, title: "Work", description: "work Expenses", balance: 1146.0,creationDate: DateTime(2005, 5, 15)),
  //         LedgerBook(id: 2, title: "Home", description: "Home Expenses", balance: 900.0,creationDate: DateTime(2005, 5, 15)),
  //       ],
  //       alerts: [
