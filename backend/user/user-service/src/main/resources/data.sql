...
-- MERGE INTO t_permissions (id, service_name, permission_bit) KEY(id) VALUES (0, 'basic', 1);
-- MERGE INTO t_permissions (id, service_name, permission_bit) KEY(id) VALUES (1, 'hadoop-client', 1);
