...
import com.pokemoney.leaf.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    private static final Logger LOGGER = LogManager.getLogger(SnowflakeZookeeperHolder.class);
