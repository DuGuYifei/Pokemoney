package com.pokemoney.leaf.leafservice.controller;
...
import com.pokemoney.leaf.leafservice.model.SegmentBufferView;
import com.pokemoney.leaf.leafservice.service.SegmentService;
...
public class LeafMonitorController {
    private Logger logger = LogManager.getLogger(LeafMonitorController.class);
